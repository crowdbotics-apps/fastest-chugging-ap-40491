...
## Project Structure
    ...
    ├── fastest_chugging_ap_40491  # Django project configurations
...
1. Clone this repo and `cd fastest_chugging_ap_40491`
...
2. Clone this repo and `cd fastest_chugging_ap_40491`
