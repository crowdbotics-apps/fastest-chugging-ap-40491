"""
Django settings for fastest_chugging_ap_40491 project.
...
ROOT_URLCONF = 'fastest_chugging_ap_40491.urls'
...
WSGI_APPLICATION = 'fastest_chugging_ap_40491.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fastest_chugging_ap_40491 API",
    "DESCRIPTION": "API documentation for fastest_chugging_ap_40491 App",
    "VERSION": "v1",
}
